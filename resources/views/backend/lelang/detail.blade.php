    ...
    <div class="col-md-12">
        <div class="card-header" style="background-color: #2f4f4f; padding: 0.1% 0.1% 0.1% 0.1%">
                ...
                @foreach($lelang as $lel)
                     <h3 style="color:white;" align="center" class="unselect">Detail Lelang {{$lel->KodeLelang}}</h3>
                @endforeach
        </div>
        ...
        <div class="card-body" style="background-color:white;">
            ...
            <table border class="table table bordered table-hover" id="table1" name="table1" style="text-align:center;">
                ...
                <tbody>
                    <td><input type="text" readonly name="OpenBid" class="form-control" value="Rp {{number_format($lel->OpenBid)}} .-"></td>
                    <td><input type="text" readonly name="BuyItNow" class="form-control" value="Rp {{number_format($lel->BuyItNow)}} .-"></td>
                </tbody>
            </table>
            ...
            <table border class="table table bordered table-hover" id="table1" name="table1" style="text-align:center;">
                ...
                <tbody>
                    <td><input type="text" readonly name="Kelipatan1" class="form-control" value="Rp {{number_format($lel->Kelipatan1)}} .-"></td>
                    <td><input type="text" readonly name="Kelipatan2" class="form-control" value="Rp {{number_format($lel->Kelipatan2)}} .-"></td>
                    <td><input type="text" readonly name="Kelipatan3" class="form-control" value="Rp {{number_format($lel->Kelipatan3)}} .-"></td>
                    <td><input type="text" readonly name="Kelipatan4" class="form-control" value="Rp {{number_format($lel->Kelipatan4)}} .-"></td>
                </tbody>
                    </table>

                    <br/>
                     <div style="text-align:center;">
                <a href="/admin/lelang/dalamantrian" type="cancel" class="btn btn-info">Kembali</a>
        </form>
    </div>
</div>
</div>
