...
<div class="row justify-content-center">
	<div class="col-md-12">
		...
		@foreach($lelang as $lel)
                     <h3 style="color:white;" align="center" class="unselect">Edit Jadwal {{$lel->KodeLelang}}</h3>
              @endforeach
    	</div>
		...
		<div class="card-body" style="background-color:white;">
            ...
            <table border class="table table bordered table-hover" id="table1" name="table1" style="text-align:center;">
                    ...
                    <div class="form-group">
                        <label for="TanggalMulai" >Tanggal Mulai :
                         ...
                         <div class="input-group date" id="inputDate1">
                             <input type="text" required class="form-control" name="TanggalMulai" id="inputDate1" style="text-align:center;" value="{{\Carbon\Carbon::parse($lel->TanggalMulai)->format('Y-m-d')}}">
                    ...
                    <div class="form-group">
                        <label for="TanggalMulai" >Jam Mulai :
                         ...
                         <div class="input-group date" id="inputTime1">
                             <input type="text" required class="form-control" name="JamMulai" id="inputTime1" style="text-align:center;" value="{{\Carbon\Carbon::parse($lel->TanggalSelesai)->format('h:i:s')}}">
                             <span class="input-group-addon">
                                 <span class="glyphicon glyphicon-calendar"></span>
                             </span>
                         </div>
                     ...
                     <div class="form-group">
                        <label for="TanggalMulai" >Tanggal Selesai :
                         ...
                         <div class="input-group date" id="inputDate2">
                             <input type="text" required class="form-control" name="TanggalSelesai" id="inputDate2" style="text-align:center;" value="{{\Carbon\Carbon::parse($lel->TanggalSelesai)->format('Y-m-d')}}">
                             <span class="input-group-addon">
                                 <span class="glyphicon glyphicon-calendar"></span>
                             </span>
                         </div>
                    ...
                    <div class="form-group">
                        <label for="TanggalMulai">Jam Selesai :
                         ...
                         <div class="input-group date" id="inputTime2">
                             <input type="text" required class="form-control" name="JamSelesai" id="inputTime2" style="text-align:center;" value="{{\Carbon\Carbon::parse($lel->TanggalSelesai)->format('h:i:s')}}">
                             <span class="input-group-addon">
                                 <span class="glyphicon glyphicon-calendar"></span>
                             </span>
                         </div>
                ...
                <tbody>
                    <td><input type="text" name="OpenBid" class="form-control" value="{{$lel->OpenBid}}"></td>
                    <td><input type="text" name="BuyItNow" class="form-control" value="{{$lel->BuyItNow}}"></td>
                </tbody>
            </table>
            ...
            <table border class="table table bordered table-hover" id="table1" name="table1" style="text-align:center;">
                ...
                <tbody>
                    <td><input type="text" name="Kelipatan1" class="form-control" value="{{$lel->Kelipatan1}}"></td>
                    <td><input type="text" name="Kelipatan2" class="form-control" value="{{$lel->Kelipatan2}}"></td>
                    <td><input type="text" name="Kelipatan3" class="form-control" value="{{$lel->Kelipatan3}}"></td>
                    <td><input type="text" name="Kelipatan4" class="form-control" value="{{$lel->Kelipatan4}}"></td>
                </tbody>
                    </table>
