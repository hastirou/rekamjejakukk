...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4" style="background-color: #2f4f4f;">
    ...
    <a href="/" class="brand-link">
      <img src="{{ asset('/images/logonih.png')}}" alt="BID.In Logo" class="brand-image img-circle elevation-3" style="opacity: 1">
      <span class="brand-text font-weight-light">BID.In Admin</span>
    </a>
